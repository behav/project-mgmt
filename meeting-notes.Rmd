...
4. Overall level of illumination {bright, medium, dark}
5. Camera position {fixed, in-motion}
6. Size (approximate proportion of field of view) taken up by {face, hands, whole bodies}
7. Video resolution (in pixels)
8. Video resolution (in temporal sampling or frame rate)
9. Video colormap: grayscale or RGB color
10. Accompanying Datavyu codes that relate to emotional expression or some type of physical movement that could have a distinctive body pose pattern
